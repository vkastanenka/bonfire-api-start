...
// 	switch q.Direction {
// 	case "around":
// 		messages, listErr = h.service.ListAround(r.Context(), actorID, path.ChannelID, q.CursorID)
// 	case "before":
// 		messages, listErr = h.service.ListBefore(r.Context(), actorID, path.ChannelID, q.CursorID)
// 	case "after":
// 		messages, listErr = h.service.ListAfter(r.Context(), actorID, path.ChannelID, q.CursorID)
// 	}
...
// 	pins, err := h.service.ListPinned(r.Context(), actorID, path.ChannelID, q.CursorID, q.CursorPinnedAt)
// 	if err != nil {
// 		return err
// 	}
...
// 	msg, err := h.service.UpdateContent(r.Context(), actorID, path.ChannelID, path.MessageID, req.Content)
// 	if err != nil {
// 		return err
// 	}
...
// 	msg, err := h.service.UpdatePinnedAt(r.Context(), actorID, path.ChannelID, path.MessageID, req.IsPinned)
// 	if err != nil {
// 		return err
// 	}
...
// 	if err := h.service.Delete(r.Context(), actorID, path.ChannelID, path.MessageID); err != nil {
// 		return err
// 	}
...
// 	count, err := h.service.ToggleReaction(r.Context(), actorID, path.ChannelID, path.MessageID, req.Emoji)
// 	if err != nil {
// 		return err
// 	}
