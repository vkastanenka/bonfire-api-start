...
type OutboxGetPath struct {
	ID uuid.UUID `path:"id" validate:"required,uuid"`
}

func (h *Outbox) Get(w http.ResponseWriter, r *http.Request) error {
	var path OutboxGetPath
